...
<head>
    <title>NewTech | Add products</title>
        ...
        <div class="row">
            <div class="col-12 col-lg-3 bg-dark pt-5 pb-5">
                <div class="row g-2">
                    ...
                    <div class="col-12 d-grid">
                        <button class="btn btn-outline-light">Product Updating</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12 bg-light">
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                <h3 class="text-dark ">Product Adding</h3>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingPassword" placeholder="Product name">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="adminimages/manageproduct.png" height="210px" width="190px" />
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <!-- to display current date and time calculating realtime by php -->
                                <div class="form-floating">
                            ...
                            <div class="col-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingPassword" placeholder="Quantity">
